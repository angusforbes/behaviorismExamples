 ...
 * @author angus
 */
public class TextureVideo131 extends TextureImage
  implements VideoRendererListener, BufferDownloadListener, TextureData.Flusher
{
   ...
   */
  public TextureVideo131(URI uri)
  {
    initializeVideo(uri);
  }

  public TextureVideo131(URI uri, boolean autoStart)
  {
    initializeVideo(uri);
...
//    System.out.println("VideoRenderEvent = " + rendererEvent.getClass());
//    System.out.println("VideoRenderEvent source = " + rendererEvent.getSource().getClass());
  w = vrc.getFrameWidth();
    h = vrc.getFrameHeight();

    Object src = rendererEvent.getSource();
    System.out.println("src of type : " + src.getClass());

    PlayerPeer playerPeer = ((PlayerPeer)src);

    System.out.println("a");
       MediaPeer mediaPeer = playerPeer.getMediaPeer();
    System.out.println("MediaPeer = " + mediaPeer.getClass());
    System.out.println("MediaPeer = " + mediaPeer);

    //System.out.println(
    VideoDataBuffer vdb = new VideoDataBuffer(null, 0, 0, 0, null);
    System.out.println("b");
   // examples.videos.CoreVideoBuffer cvb = (examples.videos.CoreVideoBuffer) vdb;
    //System.out.println("c");
    //System.out.println("cvb = " + cvb);
    //w = vdb.getWidth();
    //h = vdb.getHeight();

  
    System.out.println("w / h = " + w + " / " + h);
    playerPeer.getFrameData(vdb);
    //System.out.println("buffer of type : " + vdb.getClass());
    //playerPeer.getFrameData(cvb);
 //   System.out.println("buffer of type : " + cvb.getClass());


    this.BUFFER = vdb.getBuffer();
    playerPeer.releaseFrameData(vdb);
   // Utils.sleep(500);
...
//  }
  ...
  int IDX = 0;
  Buffer BUFFER; // = ByteBuffer.allocateDirect(101376).asIntBuffer();
  ...
  public boolean updateTexture()
  {
    ...
    {
      System.out.println("no texture data yet...");
...
//    VideoDataBuffer vdb = new VideoDataBuffer(null, 0, 0, 0, null);
//    //VideoDataBuffer vdb = new VideoDataBuffer(BUFFER, 176, 144, 704, VideoDataBuffer.Format.XRGB);
//    vrc.getData(vdb);
//    System.out.println("vdb = " + vdb);
//
//    Buffer vdbBuf = vdb.getBuffer();
//
//    System.out.println("BUFFER = " + BUFFER);
//    //Buffer bbb = vdb.getBuffer();
//    this.BUFFER = vdbBuf;
...
//Utils.sleep(700);
	...
	//return false;
      ...
      //System.out.println("BUFFER IS NOT NULL!");
     	//TextureData(GLProfile glp, int internalFormat,
      //int width, int height, int border,
      //int pixelFormat, int pixelType,
      //boolean mipmap, boolean dataIsCompressed, boolean mustFlipVertically,
      //Buffer buffer, TextureData.Flusher flusher)

      //RenderUtils.getGL().glPixelStorei(GL2.GL_PACK_ALIGNMENT, 4);
//
      textureData =
	      new TextureData(
	      GL2.GL_RGB,
