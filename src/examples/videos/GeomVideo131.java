...
public class GeomVideo131 extends GeomRect
{
  public int hola = 88;
...
//  TextureVideo jmc;
  ...
  public GeomVideo131(Point3f p3f, float w, float h, TextureVideo131 ti)
  {
    super(p3f, w, h);
    setTexture(ti);
  ...
  public GeomVideo131(TextureVideo131 ti)
  {
  ...
  public GeomVideo131(Point3f p3f, float maxSize, TextureVideo131 ti)
  {
    super(p3f, 1f, 1f);
    setTexture(ti);
