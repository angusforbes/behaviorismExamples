...
public class WorldText extends World
{
  ...
  //  GeomSimpleText g = new GeomSimpleText(true, 300, 200, "greetings", "Gill Sans", Font.PLAIN, 100);
    GeomSimpleText g = new GeomSimpleText(new Point3f(0f, 0f, 0f), "greetings", "Gill Sans", Font.PLAIN, 100);
    g.backgroundColor = new Colorf(1f, 0f, 0f, 1f);
...
//    r.setColor(1f,0f,0f,1f);
    ...
    TextBuilder gtb = new TextBuilder("hello"). //font("").
      //constrainByWidth(100).
      exactBounds(true).
      exactPadding(0, 0).
